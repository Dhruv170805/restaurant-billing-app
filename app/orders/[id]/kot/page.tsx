...
export default function KitchenTokenPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const timeStr = orderDate.toLocaleTimeString(locale, { hour: '2-digit', minute: '2-digit', hour12: true })
    const dateStr = orderDate.toLocaleDateString(locale, { day: '2-digit', month: '2-digit', year: 'numeric' })
